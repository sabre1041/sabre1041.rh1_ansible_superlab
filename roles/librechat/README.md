# sabre1041.rh1_ansible_superlab librechat Role
...
- name: Execute tasks on servers
  hosts: servers
  roles:
    - role: sabre1041.rh1_ansible_superlab.run
      run_x: 42
```
...
```yaml
- name: Initialize the run role from sabre1041.rh1_ansible_superlab
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of run role
      ansible.builtin.include_role:
        name: sabre1041.rh1_ansible_superlab.run
      vars:
        run_x: 42
```
